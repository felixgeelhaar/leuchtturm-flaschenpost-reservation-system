      ...
      <div class="error-boundary-content">
        ...
        <div class="error-details">
          ...
          <p class="error-description">
            Es tut uns leid, aber etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder kontaktieren Sie uns, wenn das Problem weiterhin besteht.
          </p>
          
          <div v-if="isDevelopment && errorDetails" class="error-debug">
            <details class="error-stack">
              <summary class="error-stack-summary">Technische Details (Entwicklung)</summary>
              <div class="error-stack-content">
                <p><strong>Fehler:</strong> {{ errorDetails.message }}</p>
                <p><strong>Komponente:</strong> {{ errorDetails.componentName }}</p>
                <pre v-if="errorDetails.stack" class="error-stack-trace">{{ errorDetails.stack }}</pre>
              </div>
            </details>
          </div>
