...
test.describe('Magazine Reservation System', () => {
  ...
  test.describe('Pickup Flow', () => {
    test('should complete pickup reservation without pictures', async ({ page }) => {
      // Select magazine
      ...
      await page.selectOption('#pickupLocation', 'BRK Haus für Kinder - Leuchtturm');
      ...
      await expect(page.locator('.alert-success')).toContainText('Reservierung erfolgreich');
    });

    test('should complete pickup reservation with group picture', async ({ page }) => {
      // Select magazine
      await page.selectOption('#magazineId', { index: 1 });
    ...
    test('should complete pickup with both group and vorschul pictures', async ({ page }) => {
      // Select magazine
      await page.selectOption('#magazineId', { index: 1 });
      await page.waitForTimeout(500);
  ...
  test.describe('Shipping Flow', () => {
    test('should complete shipping reservation with PayPal', async ({ page }) => {
      // Select magazine
      await page.selectOption('#magazineId', { index: 1 });
      await page.waitForTimeout(500);
