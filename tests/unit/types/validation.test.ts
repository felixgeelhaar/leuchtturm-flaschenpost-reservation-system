...
describe('Type Validation and Guards', () => {
  describe('ConsentData Validation', () => {
    ...
    it('validates essential consent requirement', () => {
      ...
      expect(validateEssentialConsent({
        essential: true,
        functional: false,
        analytics: false,
        marketing: false,
  ...
  describe('Address Validation', () => {
    it('validates address structure', () => {
      ...
      const isValidAddress = (address: any): address is Address => {
        return (
          ...
          (address.addressLine2 === undefined || typeof address.addressLine2 === 'string')
        );
      };
    ...
    it('validates supported countries', () => {
      ...
      const isSupportedCountry = (country: string): country is SupportedCountry => {
  ...
  describe('ReservationFormData Validation', () => {
    it('validates complete form data structure', () => {
      ...
      const isValidReservationFormData = (data: any): data is ReservationFormData => {
        return (
          typeof data === 'object' &&
          data !== null &&
          ...
          (data.deliveryMethod === 'pickup' || data.deliveryMethod === 'shipping') &&
    ...
    it('validates delivery method constraints', () => {
      const validateDeliveryConstraints = (data: ReservationFormData): boolean => {
    ...
    it('validates field length constraints', () => {
      const validateFieldLengths = (data: ReservationFormData): { isValid: boolean; errors: string[] } => {
        const errors: string[] = [];
