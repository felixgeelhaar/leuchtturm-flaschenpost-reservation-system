  ...
  describe('Consent Management', () => {
    describe('recordConsent', () => {
      ...
      it('records consent with custom metadata', async () => {
        ...
        await GDPRComplianceManager.recordConsent(
          'user-123',
          mockConsents,
          metadata,
        );
  ...
  describe('Data Subject Rights', () => {
    describe('requestDataExport', () => {
      it('requests and returns data export blob', async () => {
        ...
        const result =
          await GDPRComplianceManager.requestDataExport('user-123');
    ...
    describe('requestDataDeletion', () => {
      ...
      it('requests data deletion with custom reason', async () => {
        await GDPRComplianceManager.requestDataDeletion(
          'user-123',
          'account_closure',
        );
      ...
      it('clears local data after successful deletion', async () => {
        ...
        const clearUserDataSpy = vi
          .spyOn(GDPRComplianceManager, 'clearLocalUserData' as any)
          .mockImplementation(() => {});
    ...
    describe('requestDataRectification', () => {
      it('requests data rectification successfully', async () => {
        ...
        await GDPRComplianceManager.requestDataRectification(
          'user-123',
          updates,
        );
      ...
      it('throws error when rectification fails', async () => {
        ...
        await expect(
          GDPRComplianceManager.requestDataRectification('user-123', {
            firstName: 'Jane',
          }),
