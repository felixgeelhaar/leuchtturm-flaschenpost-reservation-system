  ...
  .then(async ({ EmailService }) => {
    ...
    async function testAllEmails() {
      ...
      try {
        ...
        console.log(
          '   Should show: "Wir melden uns in Kürze bezüglich eines Abholtermins"',
        );
        ...
        console.log(
          "   PayPal link: https://paypal.me/felixgeelhaar/9,30EUR\n",
        );
        ...
        console.log(
          '[ ] Pickup emails show "Wir melden uns in Kürze bezüglich eines Abholtermins"',
        );
        console.log(
          "[ ] Shipping emails show correct total with shipping costs",
        );
